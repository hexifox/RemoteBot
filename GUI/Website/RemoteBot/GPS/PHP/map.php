<?php
  ...
  $apikey = "AIzaSyAXyrkTTWTtkAoukyKGpQkfd_bYx2Uqte8";
  $id = $_GET['id'];
  ...
  $findmap = "SELECT centerLat, centerLong, zoom FROM maps ORDER BY id DESC LIMIT 0, 1";
        ...
        var map = new google.maps.Map(document.getElementById("map-canvas"),
            ...
            <?php
                $getpoints = "SELECT pointLat, pointLong, pointText 
                    FROM mappoints ORDER BY id DESC LIMIT 0, 1";
